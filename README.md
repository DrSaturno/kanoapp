...
Las pruebas automatizadas usan bases aisladas, nunca `.kano/db`. El recorrido de navegador y su evidencia se documentan en [verificación R1a](docs/specs/first-vertical-slice/verification.md). El workflow de GitHub ejecuta tipos, lint, tests y build; no envía notificaciones ni provisiona servicios.
...
src/modules/          Identidad, alumnos, catálogo, inscripciones, cobros y consultas
